        ...
        <div class="container">
            <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
                ...
                <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
                    ...
                    <li>
                        <a href="{{ route('events') }}" class="nav-link px-2 {{ request()->routeIs('events') ? 'text-white' : 'text-secondary' }}">
                            Events
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('loadmore') }}" class="nav-link px-2 {{ request()->routeIs('loadmore') ? 'text-white' : 'text-secondary' }}">
                            loadmore
                        </a>
                    </li>
